...
INPUT: seed; the top candidate's matched attributes with their sources; its urls; runner-up summary; budget left; queries already run.
(≤2 actions)
-->
...
3. Never search for a query already run — see "Queries already run" in the input.
