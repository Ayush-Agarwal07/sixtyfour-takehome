...
OUTPUT: {"decision":"CONFIRM|ABSTAIN|CONTINUE","cid":"c1","reasoning":"...",
         "rejected":[{"cid":"c2","reason":"..."}],"next_evidence":"...|null",
...
3. ABSTAIN if the matched evidence is weak, comes only from aggregators, or a negative shows the candidate's current role or employer differs from the seed in the same tense.
